...
BOOL CEditListCtrlDlg::OnInitDialog()
{
	...
	m_LC.InsertColumn(0, _T("姓名"), LVCFMT_CENTER, 100);
	m_LC.InsertColumn(1, _T("学号"), LVCFMT_CENTER, 100);
	int nRow = m_LC.InsertItem(0, _T("王健永"));
	m_LC.SetItemText(nRow, 1, _T("20132553"));
	nRow = m_LC.InsertItem(0, _T("刘洋"));
